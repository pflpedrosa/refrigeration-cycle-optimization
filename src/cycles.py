...
# Calcula ciclo de dois evaporadores baseado nas variaveis de entrada
def calculate_two_evaporators_cycle(cycle_inputs):
    ...
    total_exergy_destruction = compressor_exergy_destruction + condenser_exergy_destruction         + expansion_valve_ht_exergy_destruction + evaporator_ht_exergy_destruction + regulator_expansion_valve_exergy_destruction         + expansion_valve_lt_exergy_destruction + evaporator_lt_exergy_destruction
